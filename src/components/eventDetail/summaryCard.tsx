  ...
  return (
    <div className="box-border flex flex-col mx-4 mt-8 text-white bg-center shadow-dark bg-cover md:mx-12 font-raleway h-4/5 rounded-2xl bg-background-image-1">
      <div className="relative ">
        <Link className="absolute flex items-center text-subtitle text-primary gap-2 left-4 md:left-16 top-10" to={"/"}>
      ...
      <div className="flex flex-col items-center justify-around mt-20 md:flex-row sm:mt-0 md:mt-16">
        <div className="flex-1 ">
          <div className="mx-4 md:mx-16 ">
            <h1 className="pb-6 font-bold text-title text-fifth">{event?.name}</h1>
            <h3 className="pb-8 text-subtitle text-fifth">Lorem ipsum dolor sit amet consectetur adipisicing elit. </h3>
