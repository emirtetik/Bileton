          ...
          <div className="bg-black h-[1px] flex-1 flex justify-between rounded-full">
            {items.map((item, i) => (
              <div key={i} className="flex flex-col items-center">
                ...
                <div className="mb-3 font-bold text-center text-gray-500 font-raleway ">{item.title}</div>
                <div className="w-[100px] text-center font-raleway font-bold">{item.cardTitle}</div>
              </div>
            ))}
          </div>
          <div >
